  ...
  return (
    ...
    >
      <div className="flex justify-between mb-12">
        ...
        >
          <Image src={isOpenNav ? "/close.svg" : "/hide.png"} fill alt="logo" />
        </div>
      </div>
            ...
            >
              <div>
                <Image
                  width="20"
                  height="20"
                  src={option === 1 ? "/discover-active.svg" : "/discover.svg"}
                  alt="discover-icon"
                />
              </div>
              <h4
            ...
            >
              <div>
                <Image
                  ...
                  height="20"
                  src={
                    option === 2 ? "/collection-active.svg" : "/collection.svg"
                  }
                  alt="collection-icon"
                />
              </div>
            ...
            >
              <div>
                <Image
                  width="20"
                  height="20"
                  src={option === 3 ? "/download-active.svg" : "/download.svg"}
                  alt="downlaod-icon"
                />
              </div>
              <h4
